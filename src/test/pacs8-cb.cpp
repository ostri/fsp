...
namespace
{
  ...
  // current working directory -- otherwise launching pacs8-cb from anywhere other than the
  // build directory would silently miss the config file and fall back to
